...
//
//
//  Created by Maximilian Brandl based on Code by Kuray ÖĞÜN on 24/08/2017.
//
//
import Foundation
import WatchKit

open class MJPEGStreamWatch: NSObject, URLSessionDataDelegate {
    ...
    open var imageView: WKInterfaceImage
    ...
    public convenience init(imageView: WKInterfaceImage, contentURL: URL) {
